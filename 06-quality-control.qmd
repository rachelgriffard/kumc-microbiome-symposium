...
**Quality filtering** discards reads (or bases) below a quality threshold. Common approaches:
- Remove any read with more than N expected errors (DADA2's approach — more principled than a simple Q threshold)
- Sliding window trimming: cut when the average quality in a window drops below a threshold (Trimmomatic)
- Simple per-base Q score cutoff
